...
 *@Description:${adapter}
 **/public class MyAdapterA extends RecyclerView.Adapter<MyAdapterA.Holder> {
    List<Shop.DataBean.HorizontalListDataBean> list;
    Context context;

    public MyAdapterA(List<Shop.DataBean.HorizontalListDataBean> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(context).inflate(R.layout.aitem_layout,null);
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(@NonNull View itemView) {
            super(itemView);
            imageView=itemView.findViewById(R.id.imgge_a);
        }
    }
//
//    @NonNull
