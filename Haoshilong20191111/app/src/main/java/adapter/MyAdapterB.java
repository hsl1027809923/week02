...
 *@Description:${adapter}
 **/public class MyAdapterB extends RecyclerView.Adapter<MyAdapterB.Holder> {
    List<Shop.DataBean.VerticalListDataBean> list;
    Context context;

    public MyAdapterB(List<Shop.DataBean.VerticalListDataBean> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(context).inflate(R.layout.bitem_layout,null);
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int i) {
        ...
        holder.textb1.setText(list.get(i).getPrice());
        holder.textb2.setText(list.get(i).getTitle());
        //点击事件
    ...
    class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(@NonNull View itemView) {
            super(itemView);
            imageView=itemView.findViewById(R.id.imgge_b);
    ...
    public interface onClickb{
        void itemClic(int postion);
    }
    onClickb onclickb;
    public void setOnclickb(onClickb onclickb){
